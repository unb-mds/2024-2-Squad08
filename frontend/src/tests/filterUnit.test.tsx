...
describe('Filtros', () => {
  const renderFilterComponent = (Component: React.ElementType) => {
    render(
      <MemoryRouter>
        <Component />
      </MemoryRouter>
  ...
  test('deve renderizar os filtros corretamente em FiltroExecutor', () => {
    ...
    const checkboxDNIT = screen.getByLabelText(/Departamento Nacional de Infraestrutura de Transportes/i) as HTMLInputElement;
  ...
  test('deve renderizar os filtros corretamente em FiltroRegiao', () => {
    ...
    const checkboxNorte = screen.getByLabelText(/Região Norte/i) as HTMLInputElement;
  ...
  test('deve renderizar os filtros corretamente em FiltroTipo', () => {
    ...
    const checkboxEducacao = screen.getByLabelText(/Educação/i) as HTMLInputElement;
  ...
  test('deve renderizar os filtros corretamente em FiltroValor', () => {
    ...
    const checkboxValor = screen.getByLabelText(/Abaixo de R\$ 100.000,00/i) as HTMLInputElement;
